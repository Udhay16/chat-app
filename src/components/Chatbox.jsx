...
import defaultAvatar from "/src/assets/default.jpg";
    ...
    {selectedUser ? (
      ...
      <header className="w-[100%] h-[82px] m:h-fit p-4 bg-white">
        <main className="flex items-center gap-3">
          ...
          <span>
            <h3 className="font-semibold text-[#2A3D39] text-lg">{selectedUser?.fullName || "ChatWave User"}</h3>
            <p className="font-light text-[#2A3D39] text-sm">@{selectedUser?.username || "ChatWave User"}</p>
            </span>
        </main>
      </header>
      ...
      <section className="h-screen w-[100%] bg-[#e5f6f3]">
        <div className="flex flex-col justify-center items-center h-[100vh]">
          ...
          <h1 className="text-[30px] font-bold text-teal-700 mt-5">Welcome to ChatWave</h1>
